    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        // ADMIN ROLE ACCESS
                        .requestMatchers(ADMIN_ROUTE)
                        .hasRole(ADMIN.name())

                        .requestMatchers(HttpMethod.GET, ADMIN_ROUTE)
                        .hasAuthority(ADMIN_READ.getPermissionName())

                        .requestMatchers(HttpMethod.POST, ADMIN_ROUTE)
                        .hasAuthority(ADMIN_CREATE.getPermissionName())

                        .requestMatchers(HttpMethod.PUT, ADMIN_ROUTE)
                        .hasAuthority(ADMIN_UPDATE.getPermissionName())

                        .requestMatchers(HttpMethod.DELETE, ADMIN_ROUTE)
                        .hasAuthority(ADMIN_DELETE.getPermissionName())
